...
public class LiveHttpUtil {
     ...
     * 观众给主播送礼物
     */
    public static void sendGift(String liveUid, String stream, int giftId, String giftCount, HttpCallback callback,boolean isBackPack) {
        int isPack=isBackPack?1:0;
     ...
     * @param callback
     */
    public static void createRoom(String title, int liveClassId, int type, int typeVal,int isShop, File file, boolean openLocation, HttpCallback callback) {
