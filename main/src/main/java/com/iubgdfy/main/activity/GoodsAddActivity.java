...
import com.iubgdfy.live.views.AbsCommonViewHolder;
import com.iubgdfy.main.R;
import com.iubgdfy.main.http.MainHttpUtil;
import com.iubgdfy.main.views.GoodsAddTaoBaoViewHolder;
import com.iubgdfy.main.views.GoodsAddXcxViewHolder;
...
import static com.iubgdfy.main.http.MainHttpConsts.SET_GOODS;
...
public class GoodsAddActivity extends AbsActivity{
    ...
    private boolean mIsOpenApplets;
    ...
    @Override
    protected void main() {
        mIsOpenApplets=CommonAppConfig.getInstance().getAppletsSwitch();
        if(mIsOpenApplets){
            PAGE_COUNT=2;
