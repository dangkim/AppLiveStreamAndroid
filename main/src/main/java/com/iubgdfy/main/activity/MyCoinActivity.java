...
import com.iubgdfy.common.bean.CoinBean;
import com.iubgdfy.common.bean.CoinPayBean;
...
import com.iubgdfy.main.adapter.CoinAdapter;
import com.iubgdfy.main.adapter.CoinPayAdapter;
...
public class MyCoinActivity extends AbsActivity implements OnItemClickListener<CoinBean>, View.OnClickListener {
    ...
    protected void main() {
        ...
        mRefreshLayout.setColorSchemeResources(com.iubgdfy.video.R.color.global);
