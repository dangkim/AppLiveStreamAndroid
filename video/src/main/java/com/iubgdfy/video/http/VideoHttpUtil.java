package com.iubgdfy.video.http;
...
public class VideoHttpUtil {
     ...
     */
    public static void saveUploadVideoInfo(String title, String thumb, String href, String goodsId,int musicId, boolean openLocation, HttpCallback callback) {
