...
public class GlideCatchUtil {
    ...
    public void clearImageAllCache() {
        ...
        String ImageExternalCatchDir = CommonAppContext.sInstance.getExternalCacheDir() + ExternalCacheDiskCacheFactory.DEFAULT_DISK_CACHE_DIR;
    ...
    public String getCacheSize() {
        try {
            return getFormatSize(getFolderSize(new File(CommonAppContext.sInstance.getCacheDir() + "/" + InternalCacheDiskCacheFactory.DEFAULT_DISK_CACHE_DIR)));
        } catch (Exception e) {
            e.printStackTrace();
        }
        return "";
