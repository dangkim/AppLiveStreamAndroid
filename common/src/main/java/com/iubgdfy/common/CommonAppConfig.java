...
import com.iubgdfy.common.utils.XmlUtil;
...
public class CommonAppConfig {
    ...
    public boolean getAppletsSwitch(){
        if (mConfig   != null){
           return mConfig.getAppletsSwitch();
        }
        return false;
    }
    ...
    public String getAppName() {
        if (TextUtils.isEmpty(mAppName)) {
            int res = CommonAppContext.sInstance.getResources().getIdentifier("app_name", "string", "com.iubgdfy.phonelive");
    ...
    public int getAppIconRes() {
        if (mAppIconRes == 0) {
            mAppIconRes = CommonAppContext.sInstance.getResources().getIdentifier("ic_launcher", "mipmap", "com.iubgdfy.phonelive");
        }
        return mAppIconRes;
    }
